 ...
 * 
 */
public class PhysicalLocation implements Parcelable {
    ...
    public PhysicalLocation (Parcel in) {
    	readInFromParcel(in);
    }
    ...
    /**
     * @return if the location has been set
     */
	...
	/**
	 * Set the values of this instance read from a Parcel object
	 * @param in
	 */
	public void readInFromParcel (Parcel in) {
