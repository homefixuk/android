...
public class MatrixGivr {
    ...
    private static final MatrixGivr tmp = new MatrixGivr();
    ...
    public MatrixGivr(MatrixGivr m) {
    ...
    public synchronized void add(MatrixGivr n) {
    ...
    public synchronized void prod(MatrixGivr n) {
        if (n == null) throw new NullPointerException();
    ...
    public synchronized boolean equals(MatrixGivr n) {
